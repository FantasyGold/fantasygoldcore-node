...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    fantasygoldd.spawn.datadir.should.equal(home + '/.fantasygold');
    fantasygoldd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/fantasygoldd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.fantasygoldd.spawn.datadir.should.equal('./data2');
  });
});
