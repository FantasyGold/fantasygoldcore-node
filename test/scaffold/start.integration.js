...
var FantasyGoldService = require('../../lib/services/fantasygoldd');
...
describe('#start', function() {
  ...
  describe('will dynamically create a node from a configuration', function() {
    ...
    it('require each fantasygoldcore-node service with default config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'fantasygoldd',
          module: FantasyGoldService,
          config: {
            spawn: {
              datadir: './data'
            }
    ...
    it('require each fantasygoldcore-node service with explicit config', function(done) {
      var node;
      var TestNode = function(options) {
        options.services[0].should.deep.equal({
          name: 'fantasygoldd',
