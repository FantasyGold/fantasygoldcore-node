...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.fantasygold', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/fantasygoldcore-node.json';
      ...
      config.services.should.deep.equal(['fantasygoldd', 'db', 'address', 'web']);
