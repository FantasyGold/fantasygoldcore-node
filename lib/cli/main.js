...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `fantasygoldcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ fantasygoldcore-node add wallet-service');
      console.log('    $ fantasygoldcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ fantasygoldcore-node remove wallet-service');
      console.log('    $ fantasygoldcore-node remove insight-api');
      console.log();
    });
