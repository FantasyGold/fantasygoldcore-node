...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.fantasygoldd.height === 150) {
            node.services.fantasygoldd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.fantasygoldd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('fantasygoldd/hashblock', function(data) {
        bus.unsubscribe('fantasygoldd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.fantasygoldd.height;
      node.services.fantasygoldd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.fantasygoldd.sendTransaction(tx.serialize(), function(err, hash) {
